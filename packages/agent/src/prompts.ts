...
export const AGENT_SYSTEM_PROMPT = [
  ...
  '  • get_api_performance(...)      — per-endpoint score, grade, breach risk + predicted time-to-breach',
  ...
  '     • When latency or error rate is climbing, call get_api_performance to see the',
  '       per-endpoint score, risk status, and predicted time-to-breach — it isolates',
  '       WHICH endpoint is trending toward the SLO breach before you commit to a root cause.',
