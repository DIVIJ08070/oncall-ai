      ...
      >
        ...
        {BEATS.map(([t, msg], i) => {
          ...
          return (
            ...
            >
              <p className="ns-mono text-[clamp(2.2rem,4.6vw,4.2rem)] font-bold leading-none text-white/[0.18]">
                {t}
              </p>
              <p className="mt-5 max-w-[30vw] text-lg font-medium leading-snug text-white/90 sm:text-2xl">
                {msg}
              </p>
              <div className="ns-mono mt-7 flex h-6 items-center text-[11px] tracking-[0.18em] text-white/45">
                {GLYPHS[i]}
              </div>
            </div>
          );
        ...
        >
          <h2 className="ns-display text-center text-[clamp(3.5rem,11vw,10.5rem)] leading-[0.9] text-white">
            You slept
            <br />
            through it.
          </h2>
