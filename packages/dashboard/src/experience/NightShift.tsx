...
import { WorldCanvas, WorldEngine } from './WorldCanvas';
...
export function NightShift() {
  ...
  return (
    <div ref={rootRef} onClickCapture={onClickCapture} className="ns-root relative bg-[#050505] text-white">
      <WorldCanvas engine={engine} />
      <Grain opacity={0.1} />
